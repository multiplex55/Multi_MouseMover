...
impl Action {
    ...
    pub fn from_string(action: &str) -> Option<Self> {
        match action.to_lowercase().as_str() {
            ...
            "help_previous_section" | "help_prev_section" => Some(Self::HelpPreviousSection),
            "help_next_page" => Some(Self::HelpNextPage),
            "help_previous_page" | "help_prev_page" => Some(Self::HelpPreviousPage),
